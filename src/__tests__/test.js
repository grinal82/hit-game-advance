...
//   test("hide should remove hole_active class from the active hole", () => {
//     goblin.appear();
//     goblin.hide();
//     expect(document.querySelector(".hole_active")).toBeFalsy();
//   });

//   // Add more tests for other methods in the Goblin class...
// });
